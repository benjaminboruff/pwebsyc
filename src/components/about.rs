...
pub fn About<G: Html>(cx: Scope) -> View<G> {
    view! {cx,
        div (class="flex flex-col justify-center items-center divide-y my-4"){
            ...
            div(class="container m-4") {
                div(class="text-lg font-medium text-gray-600 text-center m-8") {
                    "Education"
                }
                ...
                div(class="container text-lg text-gray-600 ml-14 my-4 md:ml-20") {
                    dl() {
